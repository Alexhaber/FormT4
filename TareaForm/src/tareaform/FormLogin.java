...
public class FormLogin extends Padre {
    ...
    private void btnIniciar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciar1ActionPerformed
        ...
        try
        {
            ...
            while(result.next())
            {
                String use2 = result.getString("Username");
                String passcod2 = result.getString("Password");
                
                if(use.equals("Usuario") || passcod.equals("Contraseña"))
                {
                    err.setError("Debe colocar su usuario y contraseña, si no esta registrado debe registrarse.");
                }
                else if(use.equals(use2) && passcod.equals(passcod2))
                {
                    RegistroUser RegistroFr = new RegistroUser();
                    RegistroFr.setVisible(true);
                    this.dispose();
                }
                else if(!use.equals(use2) || !passcod.equals(passcod2))
                {
